...
public class OnnxTextEmbeddingGenerationServiceTests
{
    private readonly ITestOutputHelper _testOutputHelper;
    private OnnxTextEmbeddingGenerationService _service;

    public OnnxTextEmbeddingGenerationServiceTests(ITestOutputHelper testOutputHelper)
    {
    ...
    {
        // Arrange
        _service = new OnnxTextEmbeddingGenerationService();
        ...
        embeddings[0].Length.Should().Be(768);
    }
